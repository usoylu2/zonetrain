...
#             print("Trial:")
#             print(i)
#             print("Train with regular")
#             x_train, x_test, x_valid, y_train, y_test, y_valid, depth_train, depth_test, depth_valid = \
#                 RegularTraining_train_test_split(number)
#             print(depth_train.shape, depth_test.shape, depth_valid.shape)
#             print(x_train.shape, x_test.shape, y_train.shape, y_test.shape)
#             mean_data, std_data, validation_acc, test_acc = train_function_depth(x_train, x_valid, x_test,
#                                                                                  y_train, y_valid, y_test,
#                                                                                  depth_train, depth_valid, depth_test,
#                                                                                  PATH, epoch, LR)
#             temp = test_function_depth(x_test, y_test, depth_test, mean_data, std_data, PATH)
#             print(temp)
#             c1.append(temp)
#
#             # x_train, x_test, x_valid, y_train, y_test, y_valid = ZoneTraining_train_test_split(2 / 4, number)
#             # print(x_train.shape, x_test.shape, y_train.shape, y_test.shape)
...
#
#             # print("Test with all")
#             # _, x_test, _, _, y_test, _, _, _, _ = RegularTraining_train_test_split(number)
...
#             #
#             print("Test with on")
#             _, x_test, _, _, y_test, _, _, depth_test, _ = ZoneTraining_train_test_split(2 / 4, number)
#             print(x_test.shape, y_test.shape)
#             temp = test_function_depth(x_test, y_test, depth_test, mean_data, std_data, PATH)
#             print(temp)
#             c2.append(temp)
...
#             _, x_test, _, _, y_test, _, _, depth_test, _ = ZoneTraining_train_test_split(2.6 / 4, number)
#             print(x_test.shape, y_test.shape)
#             temp = test_function_depth(x_test, y_test, depth_test, mean_data, std_data, PATH)
#             print(temp)
#             c3.append(temp)
#
#             print("Test with pre")
#             _, x_test, _, _, y_test, _, _, depth_test, _ = ZoneTraining_train_test_split(1.4 / 4, number)
#             print(x_test.shape, y_test.shape)
#             temp = test_function_depth(x_test, y_test, depth_test, mean_data, std_data, PATH)
#             print(temp)
#             c4.append(temp)
...
if __name__ == '__main__':
    ...
    for number, epoch, LR in zip(us_images, epochs, learning_rates):
        ...
        for i in range(repetition):
            ...
            # x_train, x_test, x_valid, y_train, y_test, y_valid, _, _, _ = ZoneTraining_train_test_split(2 / 4, number)
            # print(x_train.shape, x_test.shape, y_train.shape, y_test.shape)
            # mean_data, std_data, validation_acc, test_acc = train_function(x_train, x_valid, x_test, y_train, y_valid,
            #                                                                y_test, PATH, epoch, LR)
            # temp = test_function(x_test, y_test, mean_data, std_data, PATH)
            ...
            #
            print("Test with post")
            _, x_test, _, _, y_test, _, _, _, _ = ZoneTraining_train_test_split(2.6 / 4, number)
            print(x_test.shape, y_test.shape)
            temp = test_function(x_test, y_test, mean_data, std_data, PATH)
            print(temp)
            c2.append(temp)
            ...
            print("Test with on")
            _, x_test, _, _, y_test, _, _, _, _ = ZoneTraining_train_test_split(2 / 4, number)
            print(x_test.shape, y_test.shape)
            temp = test_function(x_test, y_test, mean_data, std_data, PATH)
            print(temp)
            c3.append(temp)
            ...
            print("Test with pre")
            _, x_test, _, _, y_test, _, _, _, _ = ZoneTraining_train_test_split(1.4 / 4, number)
            print(x_test.shape, y_test.shape)
            temp = test_function(x_test, y_test, mean_data, std_data, PATH)
            print(temp)
            c4.append(temp)
